...
Induction dans l'entrefer latérale (un coté).
...
\[
L_{11}(x)=\frac{N_1\,\Phi_c}{I}=\frac{2\mu_0 N_1^2 S_g}{3\!\left(x+\dfrac{l_{\mathrm{fer}}}{\mu_r}\right)},
\qquad
L_{12}(x)=\frac{N_2\,\Phi_c}{I}=\frac{2\mu_0 N_1 N_2 S_g}{3\!\left(x+\dfrac{l_{\mathrm{fer}}}{\mu_r}\right)}.
\]
...
\begin{table}[H]
\centering
\caption{Valeurs théoriques de référence (\(\frac{l_{\mathrm{fer}}}{\mu_r}=\SI{0.4}{mm}\), \(\mu_r=400\))}
\begin{tabular}{lcc}
\toprule
