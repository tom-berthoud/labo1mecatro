...
Pour un I et N fixe, on voit que le flux \(\Phi\) et l'induction \(B\) sont inversement proportionnels à \(x\) dans le cas où \(\mu_r = \infty\) et partiellement inversement proportionnels à \(x\) dans le cas où \(\mu_r < \infty\) (plus l'entrefer est petit, plus le flux et l'induction sont élevés).
